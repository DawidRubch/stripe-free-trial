...
const server = z.object({
  ...
  STRIPE_PLATINUM_PRICE_ID: z.string().min(1),
  STRIPE_PK: z.string().min(1),
  STRIPE_SK: z.string().min(1),
  STRIPE_WEBHOOK_SECRET: z.string().min(1),
  SEND_GRID_API_KEY: z.string().min(1),
  SEND_GRID_USERNAME: z.string().min(1),
  SEND_GRID_EMAIL_FROM: z.string().min(1),
  SEND_GRID_PORT: z.string().min(1),
  SEND_GRID_HOST: z.string().min(1),
});
...
const processEnv = {
  ...
  SEND_GRID_EMAIL_FROM: process.env.SEND_GRID_EMAIL_FROM,
  SEND_GRID_PORT: process.env.SEND_GRID_PORT,
